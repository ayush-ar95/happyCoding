...
print("New to python Programming",end="")   # here it will not add anything after this line ends hence new line will begin in continuation.
print("this is new line")

print("New to python Programming",end=",")   # here it will add , before new line.
print("this is new line")

print("New to python Programming",end=" jocker ")   # here it will add " whatever we write between quotes " before new line.
print("this is new line")

# we can also write multiple print in same print statements

print("New to python programming","this is new line") # writning multiple print in one print statements. here it will automatically add a space in between the statements.
